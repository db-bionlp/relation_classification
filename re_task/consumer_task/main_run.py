...
if __name__ == '__main__':
    ...
    parser.add_argument("--dev_filename", default=None, type=str, required=True, help=" test file name")

    parser.add_argument("--test_filename", default=None, type=str, required=True, help=" dev file name")
    ...
    parser.add_argument('--logging_steps', type=int, default=700, help="Log every X updates steps.")
